# Acomi — Accommodation Flow Redesign
...
Acomi’s accommodation **data model** (Building → Floor/Unit → Room → Bed) is correct for PG, Hostel, Co-Living, and Rental operations and aligns with the Phase 4 roadmap.
