# Acomi — Meal Management UI Integration (Phase 5)
...
```markdown
# Task: Implement Acomi Phase 5 — Meal Management UI (React Native)

## Context

Acomi React Native app. Phases 1–4 complete: auth, spaces, members, accommodation, occupancy, permissions, dashboard Residents module.
