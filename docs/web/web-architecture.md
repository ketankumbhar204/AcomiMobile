# CountIn Web Architecture

> Source of truth: React Native mobile app (`K:/CountIn`).  
...
| `shared/theme/` | CountIn Material 3–inspired tokens | `src/theme/` |
...
| UI library | **MUI (Material UI) v6** with custom CountIn theme | Mobile already follows Material 3 patterns; MUI tables, drawers, dialogs map cleanly |
...
## 10. Architecture principles for CountIn Web
