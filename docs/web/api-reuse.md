...
The CountIn backend must remain **shared**. Web should consume the same REST contracts as the React Native app.
...
| Inventory offline cache | AsyncStorage `@countin/inventory/cache/...` | Optional IndexedDB; or omit offline-first on web v1 |
