...
How every CountIn mobile screen should adapt to desktop density **without changing business workflows**.
...
CountIn Web primary target: **md+** (operator desktop). `xs/sm` remain usable for tablet.
