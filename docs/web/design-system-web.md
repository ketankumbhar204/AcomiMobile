# Design System — CountIn Web

Adapt the existing mobile Material 3–inspired system for desktop.  
**Do not redesign the brand.** Desktop should feel like CountIn.
...
Avoid purple gradients, cream/serif “AI default” looks, or dark-mode-first. Stay WhatsApp-green CountIn.
...
Recommended: **MUI** with a CountIn theme mapping tokens above → `palette`, `typography`, `shape`, `components` overrides.  
