...
type DashboardCustomerHeroProps = {
  spaceName: string;
...
function greetingKey(hour: number): string {
  if (hour < 12) {
    return 'dashboard.customer.greetingMorning';
  }
  if (hour < 17) {
    return 'dashboard.customer.greetingAfternoon';
  }
  return 'dashboard.customer.greetingEvening';
}

/** Compact Design A hero — matches owner dashboard visual language. */
export function DashboardCustomerHero({ spaceName, spaceTypeLabel }: DashboardCustomerHeroProps) {
